[![Travis build status shield](https://img.shields.io/travis/tintinmar1995/cozy-dispers-app/master.svg)](https://travis-ci.org/tintinmar1995/cozy-dispers-app)
[![Github Release version shield](https://img.shields.io/github/tag/tintinmar1995/cozy-dispers-app.svg)](https://github.com/tintinmar1995/cozy-dispers-app/releases)
...
Hacking the Cozy Cozy-DISPERS app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/tintinmar1995/cozy-dispers-app.git
$ cd cozy-dispers-app
$ yarn install
```
...
After the build and the stack launched, your app is now available at http://cozy-dispers-app.cozy.tools:8080.
...
If you want to work on Cozy-DISPERS and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for Cozy-DISPERS is [tintinmar1995](https://github.com/tintinmar1995), send him/her a :beers: to say hello!
...
Cozy-DISPERS is developed by tintinmar1995 and distributed under the [AGPL v3 license][agpl-3.0].
